...
public class SurfaceMaterialClassifierTest
{
	...
	public void exactTextureClassesRemainConservative()
	{
		...
		assertEquals(SurfaceMaterial.WOOD,
			SurfaceMaterialClassifier.classifyTexture(32));
		assertEquals(SurfaceMaterial.WOOD,
			SurfaceMaterialClassifier.classifyTexture(3));
		assertEquals(SurfaceMaterial.WOOD,
			SurfaceMaterialClassifier.classifyTexture(10));
		...
		assertEquals(SurfaceMaterial.UNKNOWN,
			SurfaceMaterialClassifier.classifyTexture(38));
	}
